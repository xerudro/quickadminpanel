                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.crm-customers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_profile" id="facebook_profile" value="{{ old('facebook_profile', 'https://facebook.com/') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="whatsapp_number" id="whatsapp_number" value="{{ old('whatsapp_number', '+') }}">
