                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-CrmCustomer">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.crmCustomer.fields.facebook_profile') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.crmCustomer.fields.whatsapp') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.crmCustomer.fields.whatsapp_number') }}
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="search" strict="true">
                                            ...
                                            @foreach(App\Models\CrmCustomer::WHATSAPP_SELECT as $key => $item)
                            ...
                            <tbody>
                                @foreach($crmCustomers as $key => $crmCustomer)
                                    <tr data-entry-id="{{ $crmCustomer->id }}">
                                        ...
                                        <td>
                                            {{ $crmCustomer->facebook_profile ?? '' }}
                                        </td>
                                        <td>
                                            {{ App\Models\CrmCustomer::WHATSAPP_SELECT[$crmCustomer->whatsapp] ?? '' }}
                                        </td>
                                        <td>
                                            {{ $crmCustomer->whatsapp_number ?? '' }}
                                        </td>
                                        <td>
                                            {{ $crmCustomer->skype ?? '' }}
                                        </td>
