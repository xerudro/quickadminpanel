        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('admin_panel_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/user-alerts*") ? "menu-open" : "" }} {{ request()->is("admin/expense-reports*") ? "menu-open" : "" }} {{ request()->is("admin/time-reports*") ? "menu-open" : "" }} {{ request()->is("admin/client-reports*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/users*") ? "active" : "" }} {{ request()->is("admin/roles*") ? "active" : "" }} {{ request()->is("admin/permissions*") ? "active" : "" }} {{ request()->is("admin/user-alerts*") ? "active" : "" }} {{ request()->is("admin/expense-reports*") ? "active" : "" }} {{ request()->is("admin/time-reports*") ? "active" : "" }} {{ request()->is("admin/client-reports*") ? "active" : "" }}" href="#">
                ...
                @can('accounting_dashboard_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/expense-categories*") ? "menu-open" : "" }} {{ request()->is("admin/income-categories*") ? "menu-open" : "" }} {{ request()->is("admin/expenses*") ? "menu-open" : "" }} {{ request()->is("admin/incomes*") ? "menu-open" : "" }} {{ request()->is("admin/client-transactions*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/expense-categories*") ? "active" : "" }} {{ request()->is("admin/income-categories*") ? "active" : "" }} {{ request()->is("admin/expenses*") ? "active" : "" }} {{ request()->is("admin/incomes*") ? "active" : "" }} {{ request()->is("admin/client-transactions*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('client_transaction_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.client-transactions.index") }}" class="nav-link {{ request()->is("admin/client-transactions") || request()->is("admin/client-transactions/*") ? "active" : "" }}">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/companies*") ? "menu-open" : "" }} {{ request()->is("admin/audit-logs*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/companies*") ? "active" : "" }} {{ request()->is("admin/audit-logs*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-users">
                ...
                @can('time_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/time-work-types*") ? "menu-open" : "" }} {{ request()->is("admin/time-projects*") ? "menu-open" : "" }} {{ request()->is("admin/time-entries*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/time-work-types*") ? "active" : "" }} {{ request()->is("admin/time-projects*") ? "active" : "" }} {{ request()->is("admin/time-entries*") ? "active" : "" }}" href="#">
                ...
                @can('client_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/clients*") ? "menu-open" : "" }} {{ request()->is("admin/projects*") ? "menu-open" : "" }} {{ request()->is("admin/notes*") ? "menu-open" : "" }} {{ request()->is("admin/documents*") ? "menu-open" : "" }} {{ request()->is("admin/transactions*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/clients*") ? "active" : "" }} {{ request()->is("admin/projects*") ? "active" : "" }} {{ request()->is("admin/notes*") ? "active" : "" }} {{ request()->is("admin/documents*") ? "active" : "" }} {{ request()->is("admin/transactions*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-briefcase">
                ...
                @can('dashboard_ii_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/courses*") ? "menu-open" : "" }} {{ request()->is("admin/lessons*") ? "menu-open" : "" }} {{ request()->is("admin/tests*") ? "menu-open" : "" }} {{ request()->is("admin/questions*") ? "menu-open" : "" }} {{ request()->is("admin/question-options*") ? "menu-open" : "" }} {{ request()->is("admin/test-results*") ? "menu-open" : "" }} {{ request()->is("admin/test-answers*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/courses*") ? "active" : "" }} {{ request()->is("admin/lessons*") ? "active" : "" }} {{ request()->is("admin/tests*") ? "active" : "" }} {{ request()->is("admin/questions*") ? "active" : "" }} {{ request()->is("admin/question-options*") ? "active" : "" }} {{ request()->is("admin/test-results*") ? "active" : "" }} {{ request()->is("admin/test-answers*") ? "active" : "" }}" href="#">
