...
@can('client_transaction_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.client-transactions.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ClientTransaction">
            <thead>
                <tr>
                    <th width="10">
...
@can('client_transaction_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.client-transactions.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.client-transactions.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ClientTransaction').DataTable(dtOverrideGlobals);
