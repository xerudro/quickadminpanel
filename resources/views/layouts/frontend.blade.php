                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('accounting_dashboard_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.accountingDashboard.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('client_transaction_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.client-transactions.index') }}">
                                            {{ trans('cruds.clientTransaction.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('team_user_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.team-users.index') }}">
                                            {{ trans('cruds.teamUser.title') }}
                                        </a>
                                    @endcan
                                    @can('team_role_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.team-roles.index') }}">
                                            {{ trans('cruds.teamRole.title') }}
                                        </a>
                                    @endcan
                                    @can('teams_permision_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.teams-permisions.index') }}">
                                    ...
                                    @endcan
                                    @can('dashboard_ii_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.dashboardIi.title') }}
                                        </a>
                                    @endcan
                                    @can('course_access')
