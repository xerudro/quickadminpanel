...
return [
    ...
    'expenseManagement' => [
        'title'          => 'Menaxhimi i kostove',
        'title_singular' => 'Menaxhimi i kostove',
    ],
    'expenseCategory' => [
        'title'          => 'Kategoritë e shpenzimeve',
        'title_singular' => 'Kategori Shpenzimi',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'incomeCategory' => [
        'title'          => 'Kategoritë e të ardhurave',
        'title_singular' => 'Kategori të ardhurash',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'expenseReport' => [
        ...
        'reports'        => [
            ...
            'incomeReport'      => 'Raport mbi të ardhurat',
            'incomeByCategory'  => 'Të ardhura sipas kategorisë',
            'expenseByCategory' => 'Shpenzim sipas kategorisë',
            'income'            => 'Të ardhurat',
            'expense'           => 'Shpenzim',
            'profit'            => 'Fitimi',
        ],
