...
return [
    ...
    'incomeCategory' => [
        ...
        'title_singular' => 'Κατηγορία Εισοδήματος',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'expenseReport' => [
        ...
        'reports'        => [
            ...
            'incomeReport'      => 'Αναφορά εσόδων',
            'incomeByCategory'  => 'Έσοδα ανά κατηγορία',
            'expenseByCategory' => 'Έξοδα ανά κατηγορία',
            'income'            => 'Έσοδα',
            'expense'           => 'Έξοδο',
            'profit'            => 'Κέρδος',
        ],
