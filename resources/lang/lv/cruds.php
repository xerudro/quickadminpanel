...
return [
    ...
    'clientManagementSetting' => [
        'title'          => 'Klienta pārvaldības iestatījumi',
        'title_singular' => 'Klienta pārvaldības iestatījumi',
    ],
    'currency' => [
        'title'          => 'Currencies',
    ...
    'clientStatus' => [
        'title'          => 'Klienta statusi',
        'title_singular' => 'Klienta statuss',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'clientManagement' => [
        'title'          => 'Klientu pārvaldība',
        'title_singular' => 'Klientu pārvaldība',
    ],
    'client' => [
        'title'          => 'Clients',
