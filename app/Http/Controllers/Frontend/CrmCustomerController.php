...
class CrmCustomerController extends Controller
{
    public function index()
    {
        ...
        $crmCustomers = CrmCustomer::with(['team'])->get();

        $teams = Team::get();

        return view('frontend.crmCustomers.index', compact('crmCustomers', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.crmCustomers.create');
    }
    ...
    public function edit(CrmCustomer $crmCustomer)
    {
        ...
        $crmCustomer->load('team');

        return view('frontend.crmCustomers.edit', compact('crmCustomer'));
    }
