...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Team Users
    Route::delete('team-users/destroy', 'TeamUsersController@massDestroy')->name('team-users.massDestroy');
    Route::resource('team-users', 'TeamUsersController');

    // Team Roles
    Route::delete('team-roles/destroy', 'TeamRolesController@massDestroy')->name('team-roles.massDestroy');
    Route::resource('team-roles', 'TeamRolesController');

    // Teams Permisions
    Route::delete('teams-permisions/destroy', 'TeamsPermisionsController@massDestroy')->name('teams-permisions.massDestroy');
    Route::resource('teams-permisions', 'TeamsPermisionsController');
    ...
    // Client Transactions
    Route::delete('client-transactions/destroy', 'ClientTransactionsController@massDestroy')->name('client-transactions.massDestroy');
    Route::post('client-transactions/parse-csv-import', 'ClientTransactionsController@parseCsvImport')->name('client-transactions.parseCsvImport');
    Route::post('client-transactions/process-csv-import', 'ClientTransactionsController@processCsvImport')->name('client-transactions.processCsvImport');
    Route::resource('client-transactions', 'ClientTransactionsController');
